...
\begin{frame}{Introduction}{}
  ...
  \begin{figure}
  \includegraphics[scale=0.3]{figs/ipe/BEMS-softwareArchitecture}
  \end{figure}
\end{frame}
...
\begin{itemize}
	\item Wrote method \texttt{setDeviceToActive} to add a discovered device to the list of Active Devices once it is discovered
	\item Added a modal popup to, in the future, show the list of active devices  
\end{itemize}
\end{frame}
