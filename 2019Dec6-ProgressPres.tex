...
\section{Progress on Motor Scheduling}
\begin{frame}{Progress on Motor Scheduling}	
\begin{enumerate}
\item Motor scheduling page loads properly (no missing attribute exception)
\item Save changes to schedule (update PostgreSQL database)
\item Not tested yet
\end{enumerate}
\end{frame}
